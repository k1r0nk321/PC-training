        ...
        <div style={{ padding: '10px 14px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px', marginBottom: '8px' }}>
            <div style={{ backgroundColor: '#f0f9ff', borderRadius: '8px', padding: '8px' }}>
              ...
              <p style={{ fontSize: '12px', color: '#1e293b' }}>体重：{visit3Vitals ? visit3Vitals.weight : (patient.vitals.weight || '—')}{(visit3Vitals ? visit3Vitals.weight : patient.vitals.weight) && !String(visit3Vitals ? visit3Vitals.weight : patient.vitals.weight).match(/kg/) ? 'kg' : ''}　BMI：{visit3Vitals ? visit3Vitals.bmi : patient.vitals.bmi}</p>
