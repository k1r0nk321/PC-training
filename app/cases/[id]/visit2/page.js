...
export default function Visit2Page({ params }) {
  ...
  async function fetchCase(userId) {
    try {
      ...
      if (resumed && savedV2) {
        ...
        if (savedV2.consultation) setConsultation(savedV2.consultation)
  ...
  async function handleSend() {
    ...
    if ((function() {
      ...
      return triggers.some(function(t) { return userMessage.includes(t) }) && visit2Data?.visit2Labs && !labsRevealed
    })()) {
    ...
    if (detectedTest) {
      ...
      try {
        ...
        const v2Labs = (visit2Data && visit2Data.visit2Labs) || {}
        ...
        if (!labsRevealed && visit2Data && visit2Data.visit2Labs) setLabsRevealed(true)
      } catch (e) {
