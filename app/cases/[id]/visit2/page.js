...
function PatientInfoCard({ patient, diseaseName, visit2Vitals, visit2Labs, visit1Data, labsRevealed, v1Revealed, additionalLabs, additionalImaging, v1AdditionalLabs, v1AdditionalImaging }) {
  const [infoOpen, setInfoOpen] = useState(false)
  const [labsOpen, setLabsOpen] = useState(false)
  const hasLabs = v1Revealed || labsRevealed
          ...
          {advicePanel && (
            <div style={{ marginBottom: '12px', padding: '14px', backgroundColor: '#f0fdf4', border: '2px solid #16a34a', borderRadius: '10px', position: 'relative' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                <span style={{ fontSize: '13px', fontWeight: 'bold', color: '#15803d' }}>🩺 指導医からのアドバイス（Visit 2）</span>
