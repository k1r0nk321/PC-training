...
【追加評価ポイント：生活指導の同意項目数（最優先・絶対遵守）】
- 患者が自発的に示した意欲・同意に基づく生活指導の項目は、数が多くても一切減点しない。
- 「一度に多くの指導に同意させた」「欲張りすぎ」「患者の負担が大きい」など、同意・合意した項目数の多さ自体を批判材料・マイナス評価にしてはならない。
- 患者が複数の生活改善に前向きであることは、望ましい成果として積極的に評価する。
- 実行可能性に懸念がある場合も、優先順位づけの助言として穏やかに述べるに留め、減点しないこと。
